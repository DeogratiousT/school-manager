...
@section('content')
    ...
    <ul class="nav nav-tabs nav-justified mb-3">
        <li class="nav-item">
            <a href="#details" data-toggle="tab" aria-expanded="true" class="nav-link active">
        ...
        <li class="nav-item">
            <a href="#catalogue" data-toggle="tab" aria-expanded="false" class="nav-link">
                ...
                <span class="d-none d-md-block">Catalogue</span>
            </a>
        </li>
    </ul>
                ...
                <div class="card-columns">
                    <div class="card">  
                        <div class="card-body">
                            ...
                            <p><strong>{{ $course->name }} <span>&nbsp; &#40;{{ $course->alias }}&#41;</span></strong></p>
                    ...
                    <div class="card">   
                        <div class="card-body">
                            ...
                            @isset($course->learning_outcomes)
                                {!! $course->learning_outcomes !!}
                            @else
                                <p class="text-warning">Learning Outcomes not defined</p>
                            @endisset
                        </div> 
                    </div> 
                    <div class="card">   
                        <div class="card-body">
                            ...
                            @isset($course->career_opportunities)
                                {!! $course->career_opportunities !!}
                            @else
                                <p class="text-warning">Career Opportunities not defined</p>
                            @endisset
                        </div> 
                    </div> 
            </div>
    ...
    <!-- Catalogue Tab Start -->
        <div class="tab-pane" id="catalogue">
            @if (count($course->years) > 0)
                            ...
                            <div id="{{ 'collapse'.$year->id }}" class="collapse @if ($loop->first) show @endif"
                                ...
                                <div class="card-body">
                                    ...
                                    @if (count($year->courseSemesters($course->id)) > 0)
                                                ...
                                                <div class="tab-content" id="v-pills-tabContent">
                                                    @foreach ($year->courseSemesters($course->id) as $semester)
                                                        <div class="tab-pane fade @if ($loop->first) active show @endif border border-primary p-2" id="{{ 'v-pills-'.$semester->id }}" role="tabpanel" aria-labelledby="{{ 'v-pills-'.$semester->id.'-tab' }}">
                                                            ...
                                                            @else
                                                                <p class="text-warning">No Units For This Semester</p>    
                                                            @endif
                                                        </div>
                                                    @endforeach
                                                </div> <!-- end tab-content-->
                                        ...
                                        <!-- end row-->
                                    @else
                                        <p class="text-warning">No Course Semesters Defined Yet</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                @else
                    <p class="text-warning">No Course Years Defined Yet</p>
            @endif
        </div>
        <!-- Catalogue Tab Start -->
    </div>
