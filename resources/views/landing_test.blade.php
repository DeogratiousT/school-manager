...
<head>
        <meta charset="utf-8" />
        <title>Landing | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
        ...
        <section class="py-5">
            <div class="container">
                ...
                <div class="row mt-2 py-5 align-items-center">
                    <div class="col-lg-5">
                        <img src="{{ asset('images/features-1.svg') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row pb-3 pt-5 align-items-center">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <img src="{{ asset('images/features-2.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
